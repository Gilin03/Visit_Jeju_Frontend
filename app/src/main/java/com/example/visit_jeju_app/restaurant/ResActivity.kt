...
import com.example.visit_jeju_app.databinding.ActivityResBinding
...
import com.example.visit_jeju_app.restaurant.adapter.ResAdapter
...
class ResActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.pageChange.setOnClickListener {
            val intent = Intent(this@ResActivity, ResRegionNmActivity::class.java)
            startActivity(intent)
        }
        ...
        toggle =
            ActionBarDrawerToggle(this@ResActivity, binding.drawerLayout, R.string.open, R.string.close)
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { item: MenuItem ->
            when (item.itemId) {
                R.id.home -> {
                    // 홈 아이템 클릭 처리
                    val intent = Intent(this@ResActivity, MainActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.chat -> {
                    val intent = Intent(this@ResActivity, GptActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.youtube -> {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextSubmit(query: String?): Boolean {
                ...
                Toast.makeText(this@ResActivity,"검색어가 전송됨 : ${query}", Toast.LENGTH_SHORT).show()
                return true
            }
        })

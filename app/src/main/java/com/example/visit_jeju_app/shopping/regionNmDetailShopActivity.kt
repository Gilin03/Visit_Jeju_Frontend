...
import com.example.visit_jeju_app.databinding.ActivityRegionNmDetailShopBinding
...
class regionNmDetailShopActivity : AppCompatActivity(), OnMapReadyCallback {
    lateinit var binding: ActivityRegionNmDetailShopBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityRegionNmDetailShopBinding.inflate(layoutInflater)
...
//                    Log.d("lsy", "width : ${resource.width}, height: ${resource.height}")
        ...
        mapView!!.getMapAsync(this@regionNmDetailShopActivity)
        ...
        toggle =
            ActionBarDrawerToggle(this@regionNmDetailShopActivity, binding.drawerLayout, R.string.open, R.string.close)
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { item: MenuItem ->
            when (item.itemId) {
                R.id.home -> {
                    // 홈 아이템 클릭 처리
                    val intent = Intent(this@regionNmDetailShopActivity, MainActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.chat -> {
                    val intent = Intent(this@regionNmDetailShopActivity, GptActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.youtube -> {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextSubmit(query: String?): Boolean {
                ...
                Toast.makeText(this@regionNmDetailShopActivity,"검색어가 전송됨 : ${query}", Toast.LENGTH_SHORT).show()
                return true
            }
        })

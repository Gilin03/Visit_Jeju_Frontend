...
import com.example.visit_jeju_app.databinding.ActivityAccomDetailBinding
...
class AccomDetailActivity : AppCompatActivity(), OnMapReadyCallback {
    private var mapView: com.naver.maps.map.MapView? = null
    lateinit var binding: ActivityAccomDetailBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?,) {
        binding= ActivityAccomDetailBinding.inflate(layoutInflater)
...
//        }
        ...
        mapView!!.getMapAsync(this@AccomDetailActivity)
        ...
        toggle =
            ActionBarDrawerToggle(this@AccomDetailActivity, binding.drawerLayout, R.string.open, R.string.close)
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { item: MenuItem ->
            when (item.itemId) {
                R.id.home -> {
                    // 홈 아이템 클릭 처리
                    val intent = Intent(this@AccomDetailActivity, MainActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.chat -> {
                    val intent = Intent(this@AccomDetailActivity, GptActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.youtube -> {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextSubmit(query: String?): Boolean {
                ...
                Toast.makeText(this@AccomDetailActivity,"검색어가 전송됨 : ${query}", Toast.LENGTH_SHORT).show()
                return true
            }
        })
